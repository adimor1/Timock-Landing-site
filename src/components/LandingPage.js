        ...
        <Grid container direction='column' className={classes.mainContainer}>
              ...
              <Grid container justify='flex-end' alignItems='center' direction='row'>
                <Grid sm item className={classes.heroTextContainer}>
                  <Typography variant="h2" align='center'>
                    Bring West Coast Technologhy <br/> to the Midwset
                  </Typography>
                  <Grid container justify="center" className={classes.buttonContainer}>
                      <Grid item>
                          <Button component={Link} to="/estimate" className={classes.estimateButton} onClick={()=>props.setValue(5)} variant="contained">Free Estimate</Button>
                      </Grid>
                      <Grid item>
          ...
          <Grid item>{/*--- Website Block---*/}
            <Grid container direction='row' justify={matchesSM? "center" : undefined} className={classes.servicesContainer}>
              ...
              <Grid item>
                <img className={classes.icon} alt="websitee icon" src={websiteIcon}/>
              </Grid>
            </Grid>
          </Grid>
          <Grid item>
            ...
            <Card className={classes.revolutionCard}>
                <CardContent>
                  <Grid container direction='column' style={{textAlign:"center"}}>
                    ...
                    <Grid item>
                      <Typography variant='subtitle1'>
                        Visionary insights coupled with cutting-edge technologhy is a recipe for revolution.
                      </Typography>
                      <Button component={Link} to="/revolution" className={classes.learnButtonHero} 
                      onClick={()=>{props.setValue(2); }}  variant='outlined' className={classes.learnButton}>
                           <span style={{marginRight:10}}>Learn More</span>
                            <ButtonArrow width={15} height={15} fill={theme.palette.common.blue}/>
                      </Button>
                    </Grid>
