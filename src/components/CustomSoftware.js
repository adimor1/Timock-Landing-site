            ...
            <Grid item container direction='row'>
                <Grid item className={classes.arrowContainer} style={{ marginRight: "1em", marginLeft: "-3.5em" }}>
                    <IconButton
                        ...
                        on onClick={() => props.setSelectedIndex(0)}
                    >
                        <img src={backArrow}
                ...
                <Grid item className={classes.arrowContainer}>
                    <IconButton component={Link} to='/mobile' on onClick={() => props.setSelectedIndex(2)} style={{ backgroundColor: "transparent" }}>
                        <img src={forwardArrow} alt="Fordward to ios/android app development" />
                    </IconButton>
                </Grid>
            </Grid>
